...
if (isset($_SESSION['numero']) && isset($_SESSION['Password']) && $_SESSION['role']=="admin"){
		...
		$N = (int) $_POST["numero"];
		$reponse = $bdd->query("SELECT staf_no, first_name, last_name, date_of_birth, gender, mobile, home_tel, email, address, end_date FROM staf WHERE staf_no = $N ");
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      ...
      <form action="delete_staff1.php" method="POST">
          ...
          <div class="col-lg-8 mx-auto">
            ...
            <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="End_date" value=<?php echo $donnees['end_date']?> READONLY>
                </div>
