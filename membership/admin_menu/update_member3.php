...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if(empty($errors)) {
		...
		$req=$bdd->prepare('UPDATE member SET first_name=:first_name, last_name=:last_name, date_of_birth=:date_of_birth, gender=:gender, mobile=:mobile, home_tel=:home_tel, email=:email, address=:address, end_date=:end_date WHERE member_no=:member_no');
		$req->execute(array(
		...
		//echo SELECT NOW();
		/*
		echo "Member number : ".$Member_number."<br>";
