...
<body>
	...
	if (isset($_SESSION['numero']) && isset($_SESSION['Password']) && $_SESSION['role']=="admin"){
		...
		$reponse = $bdd->query("SELECT staf_no FROM staf ");
		$C=0;
		while($data = $reponse->fetch())
		{
			if($data['staf_no'] == $N)
			{
				$bdd->exec("DELETE FROM staf WHERE staf_no = $N ");
				?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <p class="intro-text">The staff <?php echo $N ?> is delete !</p>
