...
if (isset($_SESSION['numero']) && isset($_SESSION['Password']) && $_SESSION['role']=="admin"){
		...
		$reponse = $bdd->query("SELECT staf_no, first_name, last_name, password, date_of_birth, gender, mobile, home_tel, email, address, end_date FROM staf WHERE staf_no = $N ");
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      ...
      <a class="navbar-brand"> | UPDATE STAFF | </a>
      ...
      <form action="update_staff3.php" method="POST">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="numero" value=<?php echo $donnees['staf_no'] ?> READONLY>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="Last_Name" value=<?php echo $donnees['last_name'] ?> maxlength=20 required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input name="Address" value=<?php echo $donnees['address'] ?> class="form-control" required></input>  
                </div>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-default btn-lg"> Update Staff</button>
