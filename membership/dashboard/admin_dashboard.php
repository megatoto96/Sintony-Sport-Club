...
<html lang="en">
  ...
  <body id="page-top">
    ...
    if (isset($_SESSION['numero']) && isset($_SESSION['Password'])) {
      ...
      <a class="navbar-brand"> | ADMIN OPTION | </a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <a href="../../membership/admin_menu/delete_staff.php" class="btn btn-refuse btn-lg">Delete Staff</a>
              ...
              <br/> <br />
              <a href="../admin_menu/update_staff" class="btn btn-default btn-lg">Update Staff</a>
