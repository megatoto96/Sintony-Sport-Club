...
if (isset($_SESSION['numero']) && isset($_SESSION['Password']) && $_SESSION['role']=="staff" || $_SESSION['role']=="admin"){
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      ...
      <form action="family3.php" method="POST">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
            	...
            	<label>Offers :</label> 
					<select name="family" class="custom-select">
					<option value="0">not family</option>
                ...
                <button type="submit" class="btn btn-default btn-lg"> Update Family Status</button>
