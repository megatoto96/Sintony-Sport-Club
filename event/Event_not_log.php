...
<html lang="en">
  ...
  <body id="page-top">
    ...
    if (isset($_SESSION['numero']) && isset($_SESSION['Password'])) {
      ?>
      <a class="navbar-brand"> | <?php echo $_SESSION['first_name']; ?> |</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h1>Member please log in and come back to this page:</h1>
              <p class="intro-text">For not member please complete this litle form to continue:</p> <br />
              <a href="../membership/add/Add_notmember.html" class="btn btn-default btn-lg">NOT MEMBERSHIP SIGN IN</a> <br />
              <p class="intro-text">If you all ready complete this form before pls log with your email with this link:</p> <br />
              <a href="../membership/login/login_notmember.html" class="btn btn-default btn-lg">NOT MEMBERSHIP LOGIN</a> <br />
            </div>
          </div>
        </div>
      </div>
