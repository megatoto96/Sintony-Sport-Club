...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <!-- Sintoni home button -->
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="../membership/login/logout.php">Sintoni Sports Club</a>
      ...
      <a class="navbar-brand"> | NOT MEMBER |</a>
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <p>The Zumba Club let you discover the fiber of the sportif dancing.
                ...
                ?>
                <br /> <br /> <br />
                <a href="not_member/Del_Zumba.php" class="btn btn-refuse btn-lg">Unregister</a>
                <?php
                }else
                {
                  if($Pzumba<6)
                  {
                    ?>
                    <br /> <br /> <br />
                    <a href="not_member/Add_Zumba.php" class="btn btn-accept btn-lg">Register</a>
                    <?php
                }
                else
                {
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <p>The Yoga Club let you discover the fiber of an art of the body.
                ...
                ?>
                <br /> <br /> <br />
                <a href="not_member/Del_Yoga.php" class="btn btn-refuse btn-lg">Unregister</a>
                <?php
                }else
                {
                  if($Pyoga<6)
                  {
                    ?>
                    <br /> <br /> <br />
                    <a href="not_member/Add_Yoga.php" class="btn btn-accept btn-lg">Register</a>
                    <?php
                }
                else
                {
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <p>The Fitness Club let you discover the fiber of a beautiful body.
                ...
                ?>
                <br /> <br /> <br />
                <a href="not_member/Del_Fitness.php" class="btn btn-refuse btn-lg">Unregister</a>
                <?php
                }else
                {
                  if($Pfitness<6)
                  {
                    ?>
                    <br /> <br /> <br />
                    <a href="not_member/Add_Fitness.php" class="btn btn-accept btn-lg">Register</a>
                    <?php
                }
                else
                {
            ...
            <div class="col-lg-8 mx-auto">
              ...
              <p>The Step Club let you discover how to do sport with a step.
                ...
                if($step==1)
                {
                  ?>
                  <br /> <br /> <br />
                  <a href="not_member/Del_Step.php" class="btn btn-refuse btn-lg">Unregister</a>
                  <?php
                }else
                {
                  if($Pstep<6)
                  {
                    ?>
                    <br /> <br /> <br />
                     <a href="not_member/Add_Step.php" class="btn btn-accept btn-lg">Register</a>
                    <?php
                }
                else
                {
